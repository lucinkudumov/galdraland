        ...
        $scope.$watch("adventure._id", function(newValue, oldValue){
            if (newValue != oldValue) {
                var htmlcontent = "<html><head>" +
                    ...
                    "</script>" +
                    "<div class='fb-share-button' data-href='http://galdraland-1-0.herokuapp.com/adventures/view/"+newValue+"&description=abcdefg' data-layout='button_count'></div>" +
                    "<a class='fb-xfbml-parse-ignore' target='_blank' href='https://www.facebook.com/sharer/sharer.php?description=aaaaaa&u=http%3A%2F%2Fdramatainment.com%2Fvideos.php&amp;src=sdkpreparse'>Share</a>"+
                    "</body></html>";
