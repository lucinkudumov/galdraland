            ...
            '<div ng-repeat="comnt in comments">' +
                '<table width="100%"><tr>' +
                    '<td width="50px;"><img src="{{ comnt.from.photo }}" style="width:50px;height:50px;"></td>' +
                        '<td style="text-align: left;"><p style="margin-left:10px;">{{comnt.from.fullname}}</p><p style="margin-left:10px;"> {{ comnt.createdAt | date : ' + '"yyyy-MM-dd HH:mm:ss"' + ' }}</p><p style="margin-left:10px;">{{ comnt.comment }}</p> <p ng-show="ismanager" style="margin-left:10px;">({{ comnt.status }})</p></td>' +
