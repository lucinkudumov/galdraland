        ...
        $scope.$watch("adventure._id", function(newValue, oldValue){
            if (newValue != oldValue) {
                var htmlcontent = "<html><head>" +
                    ...
                    "</script>" +
                    "<div class='fb-share-button' fb-iframe-plugin-query='description=abcdefgadfsdfsd' data-href='http://galdraland-1-0.herokuapp.com/adventures/view/"+newValue+"' data-layout='button_count'></div>" +
                    "</body></html>";
